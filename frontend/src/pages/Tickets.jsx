...
function Tickets() {
  ...
  return (
    <div>
      ...
      {loading ? (
        <div className="loading-wrap"><span className="spinner"></span>Loading tickets...</div>
      ) : (
        <table>
          <thead>
            <tr>
              ...
              <tr key={t.ticket_id}>
                ...
                <td>
                  {t.ticket_status !== 'Cancelled' && (
                    <button onClick={() => setConfirmTarget(t.ticket_id)}>Cancel</button>
                  )}
                </td>
              </tr>
            ))}
      ...
      <ConfirmModal
        message={confirmTarget ? `Cancel ticket #${confirmTarget}?` : null}
